This repository contains the backend for a medication tracking application built with Typescript, Node.js, Express.js, Google Firebase and MongoDB that stores medication data in a database.
